...
import subscriptionRouter from "./modules/subscription/subscriptions.routes"
import subscriptionController from "./modules/subscription/subscriptions.controllers";
import subscriptionServices from "./modules/subscription/subscriptions.services";
...
app.use(cors({
  origin: "https://wisefox.vercel.app",
...
app.post(
  ...
  express.raw({ type: '*/*' }), // ✅ THIS IS THE FIX
